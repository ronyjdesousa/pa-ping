...
{
        cout << "paping " << VERSION << endl;
        cout << "Originally written by " << AUTHOR << endl;
        cout << "Maintained by the " << MAINTAINER << endl;
        cout << endl;
}
...
int arguments_c::Process(int argc, pc_t argv[], arguments_c &arguments)
{
        ...
        for (int i = 1; i < argc; i++)
        {
                ...
                if ((result = arguments_c::match(i, argc, argv,
                        "-p", "--port", true,
                        arguments.Port, anyMatch)) != SUCCESS)
                {
                        return result;
                }
                ...
                if ((result = arguments_c::match(i, argc, argv,
                        "-c", "--count", true,
                        arguments.Count, anyMatch)) != SUCCESS)
                {
                        return result;
                }
                ...
                if ((result = arguments_c::match(i, argc, argv,
                        "-t", "--timeout", true,
                        arguments.Timeout, anyMatch)) != SUCCESS)
                {
                        return result;
                }
